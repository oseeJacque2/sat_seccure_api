# Generated by Django 4.2.2 on 2024-03-10 17:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('director_card_type', models.CharField(choices=[('PASSPORT', 'Passport'), ('CNI', 'CNI'), ('CIP', 'CIP'), ('AUTRES', 'AUTRES')], default='CNI', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('is_active', models.BooleanField(default=True)),
                ('job', models.CharField(default='String', max_length=100)),
                ('job_description', models.CharField(default='String', max_length=100)),
